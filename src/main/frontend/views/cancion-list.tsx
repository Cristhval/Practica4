...
const CancionEntryFormUpdate = function(props: CancionEntryFormPropsUpdate){//useCallback((props: ArtistaEntryFormPropsUpdate,{ item: art }: { item: Artista }) => {
  const dialogOpened = useSignal(false);
    ...
    const album = useSignal(props.arguments.albun);
    ...
    <main className="w-full h-full flex flex-col box-border gap-s p-m">
      ...
      <HorizontalLayout theme="spacing">
             ...
             <span>
              ...
              <Button onClick={searchBynary} theme="primary" style ={{marginLeft: '10px'}}>
      ...
      <Grid items={items}>
        ...
        <GridSortColumn path="albun" header="Album" onDirectionChanged={(e) => order(e, "albun")} ></GridSortColumn>
